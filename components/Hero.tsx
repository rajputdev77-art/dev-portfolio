    ...
    <section className="min-h-[85vh] flex items-center pt-20">
      <div className="max-w-5xl mx-auto px-6 py-20">
        ...
        <p className="text-xl md:text-2xl text-ink/80 max-w-2xl leading-relaxed mb-4">
          I build systems that make complex things run quietly — across
          operations, automation, and the spaces where people and technology
          meet.
        </p>
        <p className="text-base md:text-lg text-ink/60 max-w-xl mb-10">
          MBA. Client operations specialist. Builder of local AI systems.
          Performer turned operator.
        </p>
